...
function chronus_customize_register_blog_settings( $wp_customize ) {
	...
	$wp_customize->add_setting(
		'chronus_theme_options[blog_title]',
		array(
			'default'           => '',
			'type'              => 'option',
	...
	$wp_customize->add_setting(
		'chronus_theme_options[blog_description]',
		array(
			'default'           => '',
			'type'              => 'option',
			'transport'         => 'postMessage',
	...
	$wp_customize->add_setting(
		'chronus_theme_options[read_more_text]',
		array(
	...
	$wp_customize->add_control(
		new Chronus_Customize_Header_Control(
			$wp_customize,
			'chronus_theme_options[blog_magazine_widgets_title]',
			array(
	...
	$wp_customize->add_setting(
		'chronus_theme_options[blog_magazine_widgets]',
		array(
			'default'           => true,
			'type'              => 'option',
			'transport'         => 'refresh',
