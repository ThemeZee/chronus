...
function chronus_customize_register_post_settings( $wp_customize ) {
	...
	$wp_customize->add_control(
		new Chronus_Customize_Header_Control(
			$wp_customize,
			'chronus_theme_options[post_details]',
			array(
	...
	$wp_customize->add_setting(
		'chronus_theme_options[meta_date]',
		array(
			'default'           => true,
			'type'              => 'option',
	...
	$wp_customize->add_setting(
		'chronus_theme_options[meta_author]',
		array(
			'default'           => true,
			'type'              => 'option',
			'transport'         => 'postMessage',
	...
	$wp_customize->add_setting(
		'chronus_theme_options[meta_category]',
		array(
			'default'           => true,
			'type'              => 'option',
			'transport'         => 'postMessage',
	...
	$wp_customize->add_control(
		new Chronus_Customize_Header_Control(
			$wp_customize,
			'chronus_theme_options[single_post]',
			array(
	...
	$wp_customize->add_setting(
		'chronus_theme_options[meta_tags]',
		array(
			'default'           => true,
			'type'              => 'option',
			'transport'         => 'postMessage',
	...
	$wp_customize->add_setting(
		'chronus_theme_options[post_navigation]',
		array(
			'default'           => true,
			'type'              => 'option',
			'transport'         => 'postMessage',
	...
	$wp_customize->add_control(
		new Chronus_Customize_Header_Control(
			$wp_customize,
			'chronus_theme_options[featured_images]',
			array(
	...
	$wp_customize->add_setting(
		'chronus_theme_options[post_image_archives]',
		array(
			'default'           => true,
			'type'              => 'option',
			'transport'         => 'postMessage',
	...
	$wp_customize->add_setting(
		'chronus_theme_options[post_image_single]',
		array(
			'default'           => true,
			'type'              => 'option',
			'transport'         => 'postMessage',
