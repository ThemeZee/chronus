...
(function( $ ) {
	...
	function initNavigation( containerClass ) {
		...
		(function() {
			...
			menuToggle.on( 'click.chronus_', function() {
		...
		(function() {
			...
			var dropdownToggle = $( '<button />', { 'class': 'dropdown-toggle', 'aria-expanded': false } )
				.append( chronusScreenReaderText.icon )
				.append( $( '<span />', { 'class': 'screen-reader-text', text: chronusScreenReaderText.expand } ) );
			...
			navigation.find( '.current-menu-ancestor > button' )
				...
				.text( chronusScreenReaderText.collapse );
			...
			navigation.find( '.dropdown-toggle' ).click( function( e ) {
				...
				screenReaderSpan.text( screenReaderSpan.text() === chronusScreenReaderText.expand ? chronusScreenReaderText.collapse : chronusScreenReaderText.expand );
			} );
		})();
		...
		(function() {
			...
			function toggleFocusClassTouchScreen() {
				if ( 'none' === $( '.menu-toggle' ).css( 'display' ) ) {
					...
					$( document.body ).on( 'touchstart.chronus_', function( e ) {
					...
					menuList.find( '.menu-item-has-children > a, .page_item_has_children > a' )
						.on( 'touchstart.chronus_', function( e ) {
					...
					menuList.find( '.menu-item-has-children > a, .page_item_has_children > a' ).unbind( 'touchstart.chronus_' );
				}
			}

			if ( 'ontouchstart' in window ) {
				$( window ).on( 'resize.chronus_', toggleFocusClassTouchScreen );
				toggleFocusClassTouchScreen();
			}

			menuList.find( 'a' ).on( 'focus.chronus_ blur.chronus_', function() {
